          ...
          <div className="flex flex-col items-center w-[24rem] gap-[1.5rem]">
            ...
            <div className="relative w-[6rem] h-[6rem] flex justify-center items-center">
              ...
              <img
                src={Icon10}
                alt="success icon"
                className="relative z-10 w-[3rem] h-[3rem]"
              />
            </div>
            ...
            <Typography
              variant="bodyMd"
              className="text-body_text_color_gray text-center whitespace-nowrap"
            >
              Thank you for taking the time to complete this assessment.<br></br>
            ...
            <div className="flex w-[25.85rem] px-[1.5rem] py-[1.5rem] bg-emerald-100 rounded-[0.75rem] border border-teal-500 justify-center items-center whitespace-nowrap">
              <Typography
                variant="bodyMd"
                className="text-emerald-800 text-center"
              >
...
export default AssesmentComplete
