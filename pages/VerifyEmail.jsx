            ...
            <div className="flex h-[35rem] px-[5rem] pt-[4rem] pb-[2.25rem] justify-center items-center rounded-[0.625rem] border border-border_color bg-primary_white shadow-[0_2px_5px_rgba(0,0,0,0.20)]">
                <div className='w-[28rem] h-[28.75rem] flex flex-col justify-center items-center gap-[2rem]'>
                    ...
                    <div className='flex w-[4rem] h-[4rem] justify-center items-center rounded-full bg-[#EFF6FF]'>
                       <img src={Icon23} alt="Icon-21" className='w-full h-full p-3 object-contain'/>
                    </div>
                    {/* verify your Email div */}
                    <div className='flex w-[28rem] flex-col justify-center items-center gap-[0.75rem]'>
                        <Typography variant='headingXl'>Verify your email</Typography>
                       <Typography variant='bodyMd' className='text-body_text_color_gray text-center'>
                        We've sent a verification link to <br />{' '}
                       <span className='text-primary_black font-semibold'>alex.smith@example.com</span>. Please click the link to <br /> confirm your account.
                     </Typography>
                    </div>

                    <PrimaryButton variant={BUTTON_DEFAULT_VARIENT_TEXT.FILLED} size={BUTTON_SIZES.MEDIUM} text='Resend Email' className='!w-[28rem] !h-[3.56rem]'></PrimaryButton>
                    <div className='flex flex-col items-center self-stretch pt-6 border-t border-[#D6D6D6]'>
                            ...
                            <Typography variant="bodyMd" className="!text-body_text_color_gray">Typed the wrong email?</Typography>
            <a href="/contact"><Typography variant="bodyMd" className="text-primary_blue hover cursor-pointer">
             Change email address
            </Typography>
            </a>
              </div>
             </div>
                        <div className='flex pt-[2rem] gap-[0.5rem]'>
